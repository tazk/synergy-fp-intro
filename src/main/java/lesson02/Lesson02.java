...
public class Lesson02 {
     ...
     */
    public static final Function<Void, Void> hooray = nothing -> {
    ...
    public static final Function2<Function<Void, Void>, Integer, Function<Void, Void>> repeat =
        (operation, num) -> {
     ...
     */
    public static final Function2<Function<String, String>, Integer, Function<String, String>> concat =
        (func, num) -> {
            throw new NoSuchMethodError("concat");
        };
}
